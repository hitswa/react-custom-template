...
#### List of Languages written from right to left
...
To implememnt direction add following linedin your `LanguageContext.tsx` file in `useEffect` and `changeLanguage` function.
...
finally your `LanguageContext.tsx` will look like this
